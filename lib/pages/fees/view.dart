...
class FeesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return AppSkeleton(selectedidex: logic.currentIndex.value,
        pages: pages,
        tabsBarItems: [
          ...
          PaneItemSeparator(color: Colors.transparent),
        ], onChanged: (value ) {logic.currentIndex.value=value;  },
      );
    });
  }
}
                      ...
                      Obx(() {
                        return Row(
                          children: List.generate(
                              logic.radioButtons.length, (index) {
                            return mate.Padding(
...
class AllFees extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScaffoldPage(
      header: UsersHeaderPage(centerWidget: SizedBox(height: 100,
        child: TextFormBox(
