...
class DefaultTextField extends StatelessWidget {
  DefaultTextField({
    ...
    required this.hintText,  this.label="", this.isNumber=false,
  });
final bool? isNumber;
    ...
    return Column(
      ...
      children: [
        ...
        TextFormBox(
            ...
            ),placeholder: label,placeholderStyle: FluentTheme.of(context).typography.caption,
            validator: (text) {
      ...
      children: [
        ...
        mate.InkWell(
          onTap: () {
            showCountryPicker(
              context: context,
              showPhoneCode: true,searchAutofocus: true,
              countryListTheme: CountryListThemeData(
                  backgroundColor:
                      FluentTheme.of(context).scaffoldBackgroundColor,
                  borderRadius: BorderRadius.circular(10),searchTextStyle:FluentTheme.of(context).typography.display ,
